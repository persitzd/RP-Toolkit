function [numeric_flag, function_flag, param1_restrictions, param2_restrictions, fix_corners, ok] = HPZ_Screen_Functional_Form_Settings_Risk(numeric_flag, function_flag, param1_restrictions, param2_restrictions, fix_corners, runs_counter)
...
S.functional_form_rd(1) = uicontrol(S.bg_ff,...
    'value',(function_flag == HPZ_Constants.CRRA_func),...
    'enable','on',...
    'style','rad',...
    'unit','pix',...
    'fontsize',font_size,...
...
S.functional_form_rd(2) = uicontrol(S.bg_ff,...
    'value',(function_flag == HPZ_Constants.CARA_func),...
    'enable','on',...
    'style','rad',...
    'unit','pix',...
    'fontsize',font_size,...
