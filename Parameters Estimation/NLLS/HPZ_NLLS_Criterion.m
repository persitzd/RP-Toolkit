...
[euclidean_criterion, CFGK_criterion, normalized_euclidean_criterion, param] = HPZ_NLLS_Metrics (param, endowments, observations, treatment, function_flag, fix_corners, asymmetric_flag, pref_class, numeric_flag);
