...
data_list_str = {'Choi et al. (2007)', 'Halevy et al. (2018)' , ...
                 'Kurtz-David et al. (2019)', 'Kurtz-David et al. (2019) - blocks'};
data_list_path = {strcat(HPZ_Constants.data_files_dir, '/Data_CFGK_2007.csv'),...
                  strcat(HPZ_Constants.data_files_dir, '/Data_HPZ_2018.csv'),...
                  strcat(HPZ_Constants.data_files_dir, '/RISK_FMRI_KLPW_2019.csv'),...
                  strcat(HPZ_Constants.data_files_dir, '/RISK_FMRI_KLPW_2019.csv')};
